...
version="8.17" #example: "7.1"
id="debian" #example: debian, ubuntu
dist="bullseye" #example (for debian): bullseye, buster, jessie, wheezy, ${VERSION_CODENAME}, etc 
...
# rm -rf ~/.wine-old 2>/dev/null; mv ~/.wine ~/.wine-old 2>/dev/null
# mv /usr/local/bin/wine /usr/local/bin/wine-old 2>/dev/null
# mv /usr/local/bin/wine64 /usr/local/bin/wine-old 2>/dev/null
# mv /usr/local/bin/wineboot /usr/local/bin/wineboot-old 2>/dev/null
# mv /usr/local/bin/winecfg /usr/local/bin/winecfg-old 2>/dev/null
# mv /usr/local/bin/wineserver /usr/local/bin/wineserver-old 2>/dev/null
...
chmod +x ~/wine/bin/wine ~/wine/bin/wine64 ~/wine/bin/wineboot ~/wine/bin/winecfg ~/wine/bin/wineserver
